...
conventionals_D_add <- filter(conventionals_D, FDT_STA_ID %in% c(''))
#conventionals_D_add <- filter(conventionals_D, FDT_STA_ID %in% c('STATIONID_1','STATIONID_2','STATIONID_3')) # example filter statement

conventionals_D <- bind_rows(conventionals_D, conventionals_D_add)
...
# Bring in EVJ edited stations table
stationTable <- read_csv('data/2018_ir_mon_stations_SWRO_EVJ.csv')
