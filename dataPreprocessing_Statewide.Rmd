...
conventionals_D_Region_AU <- bind_rows(conventionals_D_Region_AU, conventionals_D_Region_Lakes)
...
conventionals_D_Region_AU <- bind_rows(conventionals_D_Region_AU, Regional_Sites_AU, conventionals_D_Region_NoAU)
...
z2 <- filter(z, STA_LV1_CODE == 'RESERV')

z <- z %>% st_geometry(NULL)
