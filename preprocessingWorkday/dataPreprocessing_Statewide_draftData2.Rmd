...
#conventionals <- read_excel('data/draft2020data/CEDSWQM_2020_IR_DATA-CONVENTIONALS_20190213.xlsx',sheet = 'CONVENTIONALS')
...
# From Mary (Rivers)
stationTable <- read_excel('data/STREAMS_ir_mon_stations_BRRO_2018_MRD.xlsx',sheet=
                             'STREAMS_WORKING_TRIAGE')
